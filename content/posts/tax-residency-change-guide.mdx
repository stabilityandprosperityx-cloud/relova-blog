...
## Table of Contents
- [What tax residency actually controls](#what-tax-residency-actually-controls)
- [The 183-day rule is only one slice](#the-183-day-rule-is-only-one-slice)
- [Comparison table: how different tests stack (simplified)](#comparison-table-how-different-tests-stack-simplified)
- [Step-by-step: how to change tax residency over twelve months](#step-by-step-how-to-change-tax-residency-over-twelve-months)
- [Evidence binder you should actually keep](#evidence-binder-you-should-actually-keep)
- [Countries to consider when restructuring (high level)](#countries-to-consider-when-restructuring-high-level)
- [How to change tax residency when you earn equity and bonuses](#how-to-change-tax-residency-when-you-earn-equity-and-bonuses)
- [How to change tax residency as a U.S. citizen](#how-to-change-tax-residency-as-a-us-citizen)
- [Split years and departure regimes: UK, Canada, Australia snapshots](#split-years-and-departure-regimes-uk-canada-australia-snapshots)
- [Founders: place of effective management vs your Instagram location](#founders-place-of-effective-management-vs-your-instagram-location)
- [Employees: permanent establishment risk for your employer](#employees-permanent-establishment-risk-for-your-employer)
- [Couples on mismatched timelines: when one partner moves first](#couples-on-mismatched-timelines-when-one-partner-moves-first)
- [Digital nomads: why **how to change tax residency** collides with workday sourcing](#digital-nomads-why-how-to-change-tax-residency-collides-with-workday-sourcing)
- [Inheritance and wealth taxes on the horizon](#inheritance-and-wealth-taxes-on-the-horizon)
- [Thirty-day sprint checklist before your move date](#thirty-day-sprint-checklist-before-your-move-date)
- [CRS and reporting: privacy is not the same as invisibility](#crs-and-reporting-privacy-is-not-the-same-as-invisibility)
- [Comparison: what taxes follow you when you move](#comparison-what-taxes-follow-you-when-you-move)
- [Common mistakes when attempting **how to change tax residency**](#common-mistakes-when-attempting-how-to-change-tax-residency)
...
- [How Expats Can Reduce Their Tax Bill Legally in 2026: 10 Strategies](/blog/expat-tax-reduction-strategies-2026) — Overlapping theme (tax).
