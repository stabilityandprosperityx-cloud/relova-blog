...
export const AUTHORS: Record<string, Author> = {
  "Anna Moore": {
    ...
    jobTitle: "Founder",
    paragraphs: [
      "Anna Moore is the founder of Relova, a relocation planning product that helps people compare countries, understand visa and document steps, and turn scattered research into a clearer move plan. Anna’s interest in the topic is personal: a relocation path that ran Russia → Cyprus → Georgia → Cyprus.",
